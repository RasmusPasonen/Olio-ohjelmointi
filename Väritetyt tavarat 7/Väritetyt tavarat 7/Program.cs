...
class Ohjelma
{
    ...
    {
        VaritettyTavara<Nuoli> varitettyNuoli = new VaritettyTavara<Nuoli>(new Nuoli(), ConsoleColor.DarkMagenta);
        varitettyNuoli.NaytaTavara();

        VaritettyTavara<Miekka> varitettymiekka = new VaritettyTavara<Miekka>(new Miekka(), ConsoleColor.DarkYellow);
        varitettymiekka.NaytaTavara();

        VaritettyTavara<Vesi> varitettymuki = new VaritettyTavara<Vesi>(new Vesi(), ConsoleColor.DarkBlue);
